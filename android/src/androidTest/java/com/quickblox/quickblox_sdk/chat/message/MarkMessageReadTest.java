...
public class MarkMessageReadTest extends BaseTest {
    ...
    public void markWithEmptyValues() throws InterruptedException {
        ...
        getInstrumentation().runOnMainSync(() -> new ChatModule().markMessageRead(MessageUtils.buildMarkMessageEmpty(), new ResultImpl() {
            @Override
    ...
    public void markWith_NULL_Values() throws InterruptedException {
        ...
        getInstrumentation().runOnMainSync(() -> new ChatModule().markMessageRead(null, new ResultImpl() {
            @Override
            public void success(Object o) {
                fail("expected: error, actual: resolve");
            }
    ...
    public void markWithWrongValues() throws InterruptedException {
        ...
        getInstrumentation().runOnMainSync(() -> new ChatModule().markMessageRead(MessageUtils.buildMarkMessageWrong(), new ResultImpl() {
            @Override
            public void success(Object o) {
                fail("expected: error, actual: resolve");
            }
    ...
    public void mark() throws InterruptedException, QBResponseException, SmackException.NotConnectedException {
        ...
        getInstrumentation().runOnMainSync(() -> new ChatModule().markMessageRead(markMessageData, new ResultImpl() {
            @Override
            public void success(Object o) {
                downLatch.countDown();
            }
