...
public class SendTypingTest extends BaseTest {
    ...
    public void sendWithWrongId() throws InterruptedException {
        ...
        getInstrumentation().runOnMainSync(() -> new ChatModule().sendIsTyping(data, new ResultImpl() {
            @Override
    ...
    public void sendToPrivate() throws InterruptedException, QBResponseException {
        ...
        getInstrumentation().runOnMainSync(() -> new ChatModule().sendIsTyping(sendTypingData, new ResultImpl() {
            @Override
            public void success(Object o) {
                downLatch.countDown();
            }
    ...
    public void sendToGroup() throws InterruptedException, QBResponseException {
        ...
        getInstrumentation().runOnMainSync(() -> new ChatModule().sendIsTyping(dialogData, new ResultImpl() {
            @Override
            public void success(Object o) {
                downLatch.countDown();
            }
